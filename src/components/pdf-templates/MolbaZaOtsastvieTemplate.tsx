...
interface MolbaZaOtsastvieTemplateProps {
  formData: {
    schoolName?: string
...
const MolbaZaOtsastvieTemplate: React.FC<MolbaZaOtsastvieTemplateProps> = ({ formData }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.fromSection, { marginTop: 10 }]}>
          <Text style={styles.label}>адрес и тел. за връзка:</Text>
        ...
        <View style={styles.content}>
          <Text style={styles.paragraph}>
            Моля да одобрите отсъствието на сина /дъщеря/ ми{' '}
          ...
          <View style={{ marginBottom: 10 }}>
            <Text style={[styles.label, { textAlign: 'right', fontStyle: 'italic', marginRight: 10 }]}>/посочват се мотивите, които налагат отсъствието/</Text>
          </View>
          ...
          <Text style={styles.paragraph}>
            Моля да счетете изложените мотиви за основателни и да одобрите отсъствието. В
...
export default MolbaZaOtsastvieTemplate
