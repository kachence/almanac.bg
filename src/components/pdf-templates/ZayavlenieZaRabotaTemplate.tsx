...
interface ZayavlenieZaRabotaTemplateProps {
  formData: {
    companyName?: string
    managerName?: string
    fullName?: string
...
const ZayavlenieZaRabotaTemplate: React.FC<ZayavlenieZaRabotaTemplateProps> = ({ formData }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.fromSection, { marginBottom: 30 }]}>
          <Text style={styles.label}>с местожителство</Text>
          <Text style={[styles.underline, { flex: 1, maxWidth: '80%' }]}>{formData.address || '..................................................................................................................'}</Text>
        </View>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.paragraph}>
            Заявявам желанието си да встъпя в трудово правоотношение с Вашата организация 
            на позицията {formData.targetPosition || '............................................................................................................................'}, 
            съгласно публикуваната обява за работа.
          </Text>

          <Text style={styles.paragraph}>
            Считам, че притежавам необходимите квалификации и професионален опит за успешното 
            изпълнение на възложените задачи и отговорности.
          </Text>
        </View>

        {/* Documents Section */}
        <View style={styles.documentsSection}>
          <Text style={styles.documentsTitle}>Към заявлението прилагам:</Text>
          <View style={styles.documentsList}>
            <Text style={styles.documentItem}>1. Автобиография с професионален опит</Text>
            <Text style={styles.documentItem}>2. Мотивационно писмо</Text>
            <Text style={styles.documentItem}>3. Референции от работодатели</Text>
            <Text style={styles.documentItem}>4. Заверени копия от дипломи и сертификати за образование и квалификация</Text>
          </View>
        </View>
...
export default ZayavlenieZaRabotaTemplate
