...
interface MolbaZaNapuskanePoradiBolestTemplateProps {
  formData: {
    companyName?: string
    managerName?: string
    fullName?: string
...
const MolbaZaNapuskanePoradiBolestTemplate: React.FC<MolbaZaNapuskanePoradiBolestTemplateProps> = ({ formData }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.paragraph}>
            На основание чл. 327 ал. 1 т. 1 КТ, моля трудовото ми правоотношение с 
            представляваното от Вас предприятие да бъде прекратено, считано от .......................... 
            г.
          </Text>

          <Text style={styles.paragraph}>
            Причината за прекратяването е невъзможност за изпълнение от моя страна на 
            трудовите задължения поради заболяване и невъзможност за осигуряване на друга 
            работа в предприятието съобразно с предписанията на здравните органи.
          </Text>
...
export default MolbaZaNapuskanePoradiBolestTemplate
