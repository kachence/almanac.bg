...
interface MolbaZaNapuskaneVzaimnoTemplateProps {
  formData: {
    companyName?: string
    managerName?: string
    fullName?: string
...
const MolbaZaNapuskaneVzaimnoTemplate: React.FC<MolbaZaNapuskaneVzaimnoTemplateProps> = ({ formData }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.paragraph}>
            С настоящата и на основание чл. 325, т. 1 от КТ, Ви моля за Вашето съгласие за 
            прекратяване на трудовото ми правоотношение с представляваното от Вас 
            предприятие.
          </Text>

          <Text style={styles.paragraph}>
            Моля, в случай, че молбата ми бъде уважена, да оформите трудовата ми книжка и да ми 
            я предадете.
          </Text>
        </View>
...
export default MolbaZaNapuskaneVzaimnoTemplate
