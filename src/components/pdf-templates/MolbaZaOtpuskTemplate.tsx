...
interface MolbaZaOtpuskTemplateProps {
  formData: {
    companyName?: string
    managerName?: string
    fullName?: string
...
const MolbaZaOtpuskTemplate: React.FC<MolbaZaOtpuskTemplateProps> = ({ formData }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.paragraph}>
            На основание чл. 155 ал. 1 т. 1 КТ, моля да ми бъде разрешено ползването на 
            платен годишен отпуск с продължителност {formData.vacationDays || '........'} работни дни, от {formData.startDate ? formatDate(formData.startDate) : '........................'} г. 
            до {formData.endDate ? formatDate(formData.endDate) : '........................'} г., който ми се полага за {formData.calendarYear || '........................'} календарна година.
          </Text>

          <Text style={styles.paragraph}>
            Моля да оформите необходимите документи и да ми предадете заповедта за отпуска.
          </Text>
...
export default MolbaZaOtpuskTemplate
