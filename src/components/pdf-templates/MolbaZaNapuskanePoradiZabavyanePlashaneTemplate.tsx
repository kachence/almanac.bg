...
interface MolbaZaNapuskanePoradiZabavyanePlashaneTemplateProps {
  formData: {
    companyName?: string
    managerName?: string
    fullName?: string
...
const MolbaZaNapuskanePoradiZabavyanePlashaneTemplate: React.FC<MolbaZaNapuskanePoradiZabavyanePlashaneTemplateProps> = ({ formData }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.paragraph}>
            На основание чл. 327 ал. 1 т. 2 КТ, прекратявам едностранно трудовото ми 
            правоотношение с представляваното от Вас предприятие да бъде прекратено, считано 
            от {formData.submissionDate ? formatDate(formData.submissionDate) : '........................'} г.
          </Text>

          <Text style={styles.paragraph}>
            Причината за прекратяването е забавяне на изплащането на дължимото ми 
            трудово възнаграждение за следния период:
          </Text>

          <Text style={styles.paragraph}>
            Начална дата: {formData.startDate ? formatDate(formData.startDate) : '........................'}
          </Text>
          
          <Text style={styles.paragraph}>
            Крайна дата: {formData.endDate ? formatDate(formData.endDate) : '........................'}
          </Text>
...
export default MolbaZaNapuskanePoradiZabavyanePlashaneTemplate
