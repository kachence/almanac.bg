...
interface MolbaZaNapuskanePoradiPensiyaTemplateProps {
  formData: {
    companyName?: string
    managerName?: string
    fullName?: string
...
const MolbaZaNapuskanePoradiPensiyaTemplate: React.FC<MolbaZaNapuskanePoradiPensiyaTemplateProps> = ({ formData }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.paragraph}>
            На основание чл. 327 ал. 1 т. 12 КТ, прекратявам едностранно трудовото ми 
          ...
          <Text style={styles.paragraph}>
            Причината за прекратяването е придобиването от моя страна на право на пенсия 
...
export default MolbaZaNapuskanePoradiPensiyaTemplate
