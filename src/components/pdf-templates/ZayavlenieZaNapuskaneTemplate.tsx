...
interface ZayavlenieZaNapuskaneTemplateProps {
  formData: {
    companyName?: string
    managerName?: string
    fullName?: string
...
const ZayavlenieZaNapuskaneTemplate: React.FC<ZayavlenieZaNapuskaneTemplateProps> = ({ formData }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.paragraph}>
            С настоящото заявление и в съответствие с разпоредбите на чл.325, т.1 от Кодекса на труда, 
            декларирам желанието си за прекратяване на трудовия ми договор, считано от{formData.resignationDate ? ` ${formatDate(formData.resignationDate)}` : '........................'} г. 
            от заеманата от мен позиция в ръководената от Вас организация.
          </Text>

          <Text style={styles.paragraph}>
            В случай че заявлението не получи одобрение, то да се разглежда като едномесечно 
            писмено предизвестие съгласно чл.326, ал.1 от КТ.
          </Text>

          <Text style={styles.paragraph}>
            Моля да бъдат оформени трудовата ми книжка и цялата необходима документация и да ми 
            бъдат предоставени при напускане.
          </Text>

          <Text style={styles.paragraph}>
            Благодаря за разбирането и се надявам заявлението да бъде уважено.
          </Text>
        </View>

        <Text style={styles.smallText}>
          Заявлението е изготвено в два екземпляра.
        </Text>
...
export default ZayavlenieZaNapuskaneTemplate
