...
interface MolbaZaNapuskaneBezPredizvestieTemplateProps {
  formData: {
    companyName?: string
    managerName?: string
    fullName?: string
...
const MolbaZaNapuskaneBezPredizvestieTemplate: React.FC<MolbaZaNapuskaneBezPredizvestieTemplateProps> = ({ formData }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.subjectLine}>
          ОТНОСНО: Прекратяване на трудовото правоотношение на основание чл.327, ал.1, т{formData.legalGroundPoint || '.....'} от Кодекса на труда.
        </Text>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.paragraph}>
            С настоящето Ви уведомявам, че считано от датата на получаване на настоящото уведомление прекратявам едностранно сключения между нас трудов договор на основание чл.327, ал.1, т{formData.legalGroundPoint || '.....'} от Кодекса на труда поради {formData.reasonDescription || '.........................................................................................................................................................................................(описание на причината, посочено в съответната разпоредба на Кодекса на труда).'}
          </Text>
...
export default MolbaZaNapuskaneBezPredizvestieTemplate
